...
public:
    ...
    ~MixingPluginEditor() override = default;
...
private:
    /*
        ...
        The attachment is what keeps the control, the parameter and the host's
    ...
    */
    ...
    AttachedSlider toneFreq;
    AttachedSlider toneGain;
    AttachedSlider toneQ;
